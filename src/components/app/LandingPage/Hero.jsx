...
export default function Hero() {
  return (
    <div className="flex flex-col text-center gap-8 justify-center w-[70%] mx-auto items-center h-full border">
      <h3 className="text-[#FFFFFF] font-[600] text-[64px] leading-100 ">
