...
export default function BroadCastModal({
      ...
      ...validate(
        {
          ...
          state,
          country,
          location: place.formatted_address || formData.location,
        },
        selectedCard
      ),
    }));
  ...
  const validate = (data, card) => {
    ...
    if (!isPositiveNumber(data.price))
      e.price = "Enter a valid amount greater than 0.";
    ...
    if (files.length > MAX_FILES)
      e.files = `You can only upload up to ${MAX_FILES} images.`;
      ...
      <div className="bg-white w-full max-w-[36em] rounded-lg shadow-lg p-0 pt-6 pb-6 relative max-h-[43rem] overflow-y-auto">
        ...
        <div className="space-y-4 pl-6 pr-6">
          ...
          <div>
            <label className="block mb-1 font-medium">
              Upload Images{" "}
              <span className="text-gray-500">(Optional, max 3)</span>
            </label>
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-3">
              <input
                ...
                onChange={handleInputChange}
                onBlur={handleBlur}
                className={`w-1/2 px-3 py-2 pr-10 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${
          ...
          <div className="flex justify-between gap-4">
            ...
            <div className="w-1/2">
              ...
              <div
                className={`flex items-center rounded px-2 border ${
