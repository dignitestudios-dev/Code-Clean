...
export const Button = ({ text, onClick, loading, type, disabled }) => {
  ...
  return (
    <div className="w-full">
      <button
        ...
        className={`px-3 rounded-[12px] w-full text-white  font-[500] text-[16px] h-[49px] ${isDisabled&&"cursor-not-allowed"} `}
      >
