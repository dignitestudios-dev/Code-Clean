...
const AccountCreatedSuccess = ({
  ...
  return (
    ...
    >
      <div className="bg-white w-[500px] px-4 pb-10 rounded-[16px] shadow-lg   items-center flex flex-col justify-center gap-3   text-center">
        ...
        <div className="w-auto flex flex-col mt-4 justify-center items-center">
          <div className="flex flex-col items-center gap-2">
            ...
            <h3 className="capitalize  text-[32px] text-[#181818] font-[600]">
              Account Created
            </h3>
