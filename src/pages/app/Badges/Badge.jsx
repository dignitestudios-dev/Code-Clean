  ...
  return (
    <>
      ...
      <div className="h-full px-10 lg:px-40  -mt-80 bottom-0 items-center gap-3 ">
        ...
        <div className="bg-[#F9FAFA] shadow-lg mb-48 rounded-[8px] mt-3">
          <div className="bg-white p-10 h-[300px] rounded-[8px] " >
            ...
            <div className="mt-8 grid gap-3 grid-cols-1 lg:grid-cols-3 ">
                ...
                >
                  ...
                  <div className="mt-3 w-full">
                    <h3 className="text-[#000000] flex items-center gap-1 text-[18px] font-bold">
                      {item?.title}{" "}
                      <img src={TickIcon} className="w-4" alt="" srcset="" />{" "}
                    </h3>
          ...
          <div className="p-10" >
          <h3 className="flex items-center mt-40 lg:mt-20 gap-2 text-[#000000]  font-[700] text-[24px] ">
            <img src={LockIcon} className="w-4" alt="CupIcon" /> Badges You Can
            Still Earn
          </h3>
          <div className="mt-8 grid gap-3 gap-y-6 grid-cols-1 lg:grid-cols-3 ">
            {LockBagdeData?.map((item, i) => (
              <div className="flex items-center gap-3 ">
                <div className="w-[140px] h-[100px] rounded-[50%] border-2 border-[#8f9090] border-dashed">
                  <img
                    src={item?.icon}
                    className="w-20 mx-auto mt-3 opacity-40 "
                    alt="CupIcon"
                  />
                </div>
                <div className="mt-3 w-full">
                  <h3 className="text-[#000000] flex items-center gap-1 text-[18px] font-bold">
                    {item?.title}{" "}
                    <img src={LockDarkIcon} className="w-4" alt="" srcset="" />{" "}
                  </h3>
                  <p className="text-[12px] font-[500] text-[#00000075]">
                    {item?.bio}
                  </p>
