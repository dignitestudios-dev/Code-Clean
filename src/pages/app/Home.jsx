...
const Home = () => {
  ...
  useEffect(() => {
    if (allservices) {
      setData(allservices); // Update data when allservices changes
    }
  }, [allservices]);
        ...
        <div className="px-10 py-8">
          ...
          {allservicesloading ? (
            <div className="flex justify-center items-center pt-10 pb-10">
              <img src="/spinner.gif" height={100} width={100} alt="" />
            </div>
          ) : (
            <>
              {isFilter && <Filter />}
                  ...
                  <div key={idx} className="p-5 rounded-xl shadow-xl bg-white hover:shadow-md transition-all">
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <h2 className="font-semibold text-md text-gray-800 cursor-pointer" onClick={() => navigate("/service-provider", { state: { id: pro.id } })}>
                            {pro.name}
                          </h2>
                      ...
                      <FaRegHeart onClick={() => navigate("/favorites")} className="text-black text-lg cursor-pointer" />
                    </div>
