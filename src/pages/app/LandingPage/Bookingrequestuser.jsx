...
const Bookingrequestuser = () => {
    ...
    const { bookingDetail, isLoading, bookingrequestdetailbyid } = useSelector((state) => state?.user);
    const dispatch = useDispatch();
    useEffect(() => {
        dispatch(fetchbookingrequestbyid(bookingId));
    }, [dispatch]);
                        ...
                        <div className="lg:col-span-2">
                            <div className="bg-white rounded-lg shadow-md p-6 mb-6">
                                ...
                                <p className="text-gray-600 mb-6">
                                    {bookingrequestdetailbyid?.description}
                                </p>
                                ...
                                <div className="flex items-center gap-8 mb-6 border-t-[1px] pt-6">
                                    <div>
                                        ...
                                        <p className="font-medium">{bookingrequestdetailbyid?.date}</p>
                                    </div>
                                    <div>
                                        <p className="text-sm text-gray-500 mb-1">Time</p>
                                        <p className="font-medium">{bookingrequestdetailbyid?.time}</p>
                                    </div>
                                </div>
                                ...
                                <div className="mb-6 border-t-[1px] pt-6">
                                    ...
                                    <div className="flex items-center space-x-2">
                                        ...
                                        <p className="font-medium">
                                            {bookingrequestdetailbyid?.city + "," + bookingrequestdetailbyid?.state}
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="mb-6 border-t-[1px] pt-6">
                                    ...
                                    <div className="grid grid-cols-3 gap-4">
                                        {bookingrequestdetailbyid?.cleaning_services?.map((item, i) => (
                                ...
                                <div className="pb-10">
                                    ...
                                    <div className="flex items-center justify-between border-t-[1px] pt-6">
                                        <div className="flex items-center space-x-3">
                                            <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center">
                                                <img
                                                    src={
                                                        ...
                                                        bookingrequestdetailbyid?.service_provider?.avatar
                                                    }
                                            ...
                                            <div>
                                                <p className="font-medium">
                                                    {bookingrequestdetailbyid?.service_provider?.name}
                                                </p>
                                                <p className="text-yellow-500 text-sm">
                                                    ⭐{bookingrequestdetailbyid?.service_provider?.rating}
                                                </p>
                                            </div>
                                        </div>
                                        <button
                                            onClick={() => {
                                                navigate("/service-provider", {
                                                    state: {
                                                        ...
                                                        id: bookingrequestdetailbyid?.service_provider?.id,
                                                    },
                                                });
                                            }}
                                ...
                                <div className="mb-6">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="flex justify-between border-t-[1px] border-slate-300 pt-3 ">
                                            ...
                                            <span className="font-medium">{bookingrequestdetailbyid?.date}</span>
                                        </div>
                                        <div className="flex justify-between border-t-[1px] border-slate-300 pt-3">
                                            <span className="text-gray-500">Time</span>
                                            <span className="font-medium">{bookingrequestdetailbyid?.time}</span>
                                        </div>
                                        <div className="flex justify-between border-t-[1px] border-slate-300 pt-3">
                                            <span className="text-gray-500">Total Duration</span>
                                            <span className="font-medium">
                                                {bookingrequestdetailbyid?.duration} hr
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="mb-6">
                                    ...
                                    <div className="space-y-2">
                                        <div className="flex justify-between border-t-[1px] border-slate-300 pt-3 font-semibold">
                                            <span>Total</span>
                                            <span>${bookingrequestdetailbyid?.total_payment}</span>
                                        </div>
                                    </div>
                                </div>
