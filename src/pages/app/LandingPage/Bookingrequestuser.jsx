              ...
              <div className="bg-white rounded-lg shadow-md p-6 mb-6">
                ...
                <div className="flex items-center gap-8 mb-6 border-t-[1px] pt-6">
                  <div>
                    ...
                    <p className="font-medium">
                      {bookingrequestdetailbyid?.date}
                    </p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500 mb-1">Time</p>
                    <p className="font-medium">
                      {bookingrequestdetailbyid?.time}
                    </p>
                  </div>
                </div>
                ...
                <div className="mb-6 border-t-[1px] pt-6">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <p className="font-medium">
                      {bookingrequestdetailbyid?.city +
                        "," +
                        bookingrequestdetailbyid?.state}
                    </p>
                  </div>
                </div>
                ...
                <div className="mb-6 border-t-[1px] pt-6">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    {bookingrequestdetailbyid?.cleaning_services?.map(
                      (item, i) => (
