...
export default function Profile() {
  ...
  const { provider_data, getprofileloading } = useSelector(
    ...
    <div>
      ...
      <div className="h-full px-10 lg:px-40  -mt-80 bottom-0 items-center gap-3 ">
        ...
        <div className="bg-[#F9FAFA] shadow-lg mb-48 rounded-[8px] p-10 mt-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-500 mt-1">
                          {userdata?.phone_number
                            ? userdata.phone_number.startsWith("+1")
                              ? userdata.phone_number
                              : `+1${userdata.phone_number}`
                            : "00000000000"}
          ...
          <BroadcastServiceRequests
            setSelectedData={setSelectedData}
            setCustombooking={setCustombooking}
            setIsRestrict={setIsRestrict}
            setIsOpen={setIsOpen}
          />
        </div>
      </div>
