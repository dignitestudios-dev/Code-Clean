...
const UserProvider = () => {
    ...
    return (
        <div>
            ...
            {/* Card Section */}
            <div className="max-w-6xl mx-auto px-6 py-10 bg-white shadow-md rounded-xl -mt-[16em] relative">
                ...
                <div className="mt-8 border rounded-lg p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm text-gray-700">
                        <div>
                            ...
                            <p className="text-gray-500">designer@dignitestudios.com</p>
                        </div>
                        <div>
                            <p className="font-medium">Phone Number</p>
                            <p className="text-gray-500">+1 462 849 558</p>
                        </div>
                        <div>
                            <p className="font-medium">Location</p>
                            <p className="text-gray-500">Florida, United States</p>
                        </div>
                    </div>
                </div>
            </div>
            <Reportuser isOpen={isReport} setIsOpen={setIsReport} />
