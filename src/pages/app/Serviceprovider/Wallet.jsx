    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="max-w-7xl mx-auto -mt-[17em] z-10 relative mb-8">
                <div className="bg-white/30 rounded-xl shadow-md p-6 flex justify-between items-center">
                    <div>
                        ...
                        <h2 className="text-3xl font-semibold text-[#ffffff]">$3,5362</h2>
                    </div>
                    <button
            ...
            {showModal && (
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
                    <div className="bg-white p-6 rounded-lg max-w-md w-full">
                        ...
                        <div className='-mt-3'>
                            <span className='text-blue-600 text-[12px] underline cursor-pointer' onClick={() => {
                        ...
                        <div className="mt-4">
                            <h2 className="text-xl font-bold text-black capitalize">withdraw funds</h2>

                            <label className="block text-sm font-medium text-gray-700 pt-3">Enter Amount</label>
                            <input
                                type="number"
                                placeholder="$200"
            ...
            {withdrawal && (
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
                    ...
                    <div className="bg-white rounded-xl p-6 md:w-[30em] shadow-2xl text-center">
                        {/* Checkmark Icon */}
                        <button onClick={() => setWithdrawal(false)} className="text-black flex justify-end  w-full">
                            <ImCross />
                        </button>
                        ...
                        {/* Title */}
                        <h2 className="text-2xl font-bold text-gray-800 mb-2">Withdraw Successfully!</h2>
                        ...
                        <form onSubmit={handleSubmit} className="mt-4">
                            ...
                            <div className="flex items-center">
                                <input
                                    ...
                                    className="mr-2"
                                />
                                <label className="text-sm text-gray-700">Save my details for future withdrawal</label>
                            </div>
                            <div className="mt-6 flex justify-center">
                                <button
                                    type="submit"
            ...
            <div className="max-w-7xl mx-auto px-0 pb-16">
                ...
                {/* Tabs */}
                <div className="flex border-b mb-0 bg-white rounded-t-2xl">
                    {["Transaction History", "Withdrawal History"].map((tab) => (
                        <button
                            key={tab}
                            onClick={() => setActiveTab(tab)}
                            className={`px-6 py-3 text-sm font-medium ${activeTab === tab
                                ? 'text-[#003973] border-b-2 border-[#003973]'
                                : 'text-gray-500 hover:text-[#003973]'
                                }`}
                        >
                            {tab}
                        </button>
                ...
                <div className="bg-white shadow overflow-x-auto rounded-b-2xl">
                    <table className="w-full text-sm text-left">
                        <thead className="bg-[#F3F9FB] text-gray-600 font-semibold">
                            <tr>
                                <th className="px-6 py-4">#</th>
                                <th className="px-6 py-4">Transactions ID</th>
                                <th className="px-6 py-4">Card Holder Name</th>
                                <th className="px-6 py-4">Account Number</th>
                                <th className="px-6 py-4">Transfer Date</th>
                                <th className="px-6 py-4">Transfer Time</th>
                        ...
                        <tbody className="text-gray-700">
                            {transactions.map((t, index) => (
                                <tr key={index} className="border-t">
                                    ...
                                    <td className="px-6 py-4">{t.account}</td>
