...
export default function AddServicesForm({ handleNext }) {
    ...
    return (
        <div className="w-full max-w-lg mx-auto py-6">
            <h2 className="text-[32px] font-bold text-[#181818] text-center">Add Your Services</h2>
            ...
            <div className="h-[200px] mt-10 w-full" >
                ...
                <div className="flex justify-center items-center h-[100%] w-full w-full border rounded-[8px] border-dashed border-[#00034A] " >
                    <button onClick={() => setShowModal(true)} className="bg-gradient-to-r from-[#00034A] to-[#27A8E2] bg-clip-text text-transparent">+ Add Service</button>
                </div>
            </div>
